          ...
          <div className="flex flex-grow">
            ...
            <div className='w-5/6 p-6 bg-white dark:bg-slate-900'>
                ...
                <div className='mt-4 mr-12 h-10 shadow-xl bg-white dark:bg-slate-900 grid grid-cols-2'>
                    <div>
                        <button
                        className={`h-full w-full rounded-l-full ${isForTutors ? 'dark:bg-white bg-slate-900 text-white':'dark:hover:bg-white hover:bg-slate-900 hover:text-slate-500 border-2 dark:border-white border-slate-900 text-black'} dark:text-slate-400`}
