...
const Footer = () => {
    return (
        <footer className="bg-gray-900 py-6 items-center">
            <span className="flex justify-center text-white">Links de Interes</span>
            <section className="flex justify-center">
                <div className="inline-block">
                    <div className="m-6 inline-flex items-center flex-wrap justify-center">
                        <div className="flex flex-col items-center w-1/4 sm:w-auto">
                            <a href="https://buscacursos.uc.cl/" title="Buscador de Cursos UC" target="_blank">
                                <div className="inline-flex items-center">
                                    ...
                                    <span className="m-4 text-sm hidden sm:inline-block text-white">Buscador de Cursos UC</span>
                                </div>
                            </a>
                        </div>
                        <div className="flex flex-col items-center w-1/4 sm:w-auto">
                            <a href="https://cai.cl/" title="Centro de Alumnos de Ingeniería" target="_blank">
                                <div className="inline-flex items-center">
                                    ...
                                    <span className="m-4 text-sm hidden sm:inline-block text-white">Centro de Alumnos de Ingeniería</span>
                                </div>
                            </a>
                        </div>
                        <div className="flex flex-col items-center w-1/4 sm:w-auto">
                            <a href="https://www.ing.uc.cl/" title="Ingeniería UC" target="_blank">
                                <div className="inline-flex items-center">
                                    ...
                                    <span className="m-4 text-sm hidden sm:inline-block text-white">Ingeniería UC</span>
                                </div>
                            </a>
                        </div>
                        <div className="flex flex-col items-center w-1/4 sm:w-auto">
